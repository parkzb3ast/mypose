...
import '../main.dart';
import 'video_edited_page.dart';
import 'video_trimmer_page.dart';
import 'package:file_picker/file_picker.dart';



class CameraScreen extends StatefulWidget {
  const CameraScreen({Key? key}) : super(key: key); //added keys
...
class _CameraScreenState extends State<CameraScreen>
  ...
  refreshAlreadyCapturedImages() async {
    ...
    for (var file in fileList) {                //for here
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: DropdownButton<ResolutionPreset>(
                                              ...
                                              DropdownMenuItem(
                                                ...
                                                child: Text(
                                                  preset
                                                      ...
                                                      .split('.')[1]
                                                      .toUpperCase(),
                                                  style: const TextStyle(       //added const. child after value
                                                      color: Colors.white),
                                                ),
                                              )
                                          ],
                                          ...
                                          hint: const Text("Select item"),    //added const
                                        ),
                                      ),
                                    ),
                                  ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          '${_currentExposureOffset       //interpolation
                                                  .toStringAsFixed(1)}x',
                                          style: const TextStyle(color: Colors.black),    //added const
                                        ),
                                      ),
                                    ),
                                  ),
                                  Expanded(
                                    child: RotatedBox(
                                      quarterTurns: 3,
                                      child: SizedBox(        //replaced Container
                                        height: 30,
                                        child: Slider(
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text(
                                              '${_currentZoomLevel            //interpolation
                                                      .toStringAsFixed(1)}x',
                                      ...
                                      InkWell(
                                        onTap: //_imageFile != null ||
                                             ...
                                             () async {
                                                ...
                                                var file1 = _videoFile!.path;
                                                GallerySaver.saveVideo(file1);
                                                        /*.then((value) => print('>>>> save value= $value'))
                                                        .catchError((err) {
                                                          print('error :( $err');
                                                        });*/
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextButton(
                                          ...
                                          style: TextButton.styleFrom(
                                            foregroundColor: _isVideoCameraSelected         //replaced primary
                                                ? Colors.black54
                                          ...
                                          child: const Text('IMAGE'),                 //added const
                                        ),
                                      ),
                                    ),
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextButton(
                                          ...
                                          child: const Text('VIDEO'),                 //added const
                                        ),
                                      ),
                                    ),
                                  ],
